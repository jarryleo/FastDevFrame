...
abstract class AsyncRvAdapterKt<T : Any> : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
     ...
     * 同时删除多个条目
     */
    open fun removeData(items: List<T>) {
        val list = data
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        (holder as AsyncRvAdapterKt<*>.ViewHolder).setData()
    }
    ...
    override fun onViewDetachedFromWindow(holder: RecyclerView.ViewHolder) {
        val viewHolder = holder as AsyncRvAdapterKt<*>.ViewHolder
    ...
    class ItemHelper(private val viewHolder: AsyncRvAdapterKt<*>.ViewHolder) : View.OnClickListener {
        ...
        fun addOnClickListener(@IdRes viewId: Int): ItemHelper {
            ...
            if (!contains) {
                getViewById<View>(viewId) { it.singleClick(this) }
        ...
        override fun onClick(v: View) {
            if (::mOnItemChildClickListener.isInitialized) {
                mOnItemChildClickListener(adapter!!, v, viewHolder.adapterPosition)
            }
        }
        ...
        fun setItemHolder(itemHolderClass: Class<out ItemHolder<out Any>>) {
            try {
                if (mItemHolder == null) {
                    ...
                    mItemHolder!!.initView(this, adapter!!.getItem(viewHolder.adapterPosition))
                }
                mItemHolder!!.bindData(this, adapter!!.getItem(viewHolder.adapterPosition))
